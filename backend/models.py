...
class BeatAnalysisCache(Base):
    """Shared, immutable browser-produced beat map keyed by song name."""

    __tablename__ = "beat_analysis_cache"

    song_key: Mapped[str] = mapped_column(String(255), primary_key=True)
